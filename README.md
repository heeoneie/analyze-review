...
└──────────────┘      └──────────┬──────────────────┘
                    ...
                    ┌────────────▼─────────────┐
                    │  core/                   │
                    │   analyzer.py            │  LLM 분류·분석
                    │   reply_generator.py     │  답글 생성
                    │   menu_profiles.py       │  주문 메뉴 파싱
                    │   priority_service.py    │  우선순위 스코어링
                    │   crawler_service.py     │  리뷰 수집
                    └──────────────────────────┘
```
...
Python 약 7,500줄 / JavaScript 약 1,900줄, 테스트 파일 23개.
